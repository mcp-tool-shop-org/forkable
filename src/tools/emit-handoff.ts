...
export const emitHandoffTool: ToolDescriptor<EmitHandoffInput, HandoffArtifact> = {
  name: "forkable_emit_handoff",
  description:
    "Emit a single, truthful handoff artifact for a destination repo: clone commands, upstream-wiring commands (if source provided), drift caveats, and the recommended next action. Designed to be the one thing forkable returns at the end of an adoption flow.",
