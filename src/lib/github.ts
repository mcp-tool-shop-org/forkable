 ...
 *
 * We pick these plugins specifically because a human running forkable at
...
const RATE_LIMIT_HANDBOOK_URL =
  "https://github.com/mcp-tool-shop-org/forkable#rate-limits";
...
export function mapGitHubError(err: unknown): ForkableError {
  ...
  if (err instanceof RequestError) {
    ...
    return new ForkableError(isRateLimit ? "GITHUB_RATE_LIMITED" : code, message, {
      hint,
      details,
      cause: err,
    });
