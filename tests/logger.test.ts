...
describe("logger redaction", () => {
  ...
  it("replaces ghp_ tokens in the log message with a redacted placeholder", () => {
    const logger = buildLogger({ defaultLevel: "info", env: { FORKABLE_LOG: "info" } });
  ...
  it("respects FORKABLE_LOG=off and writes nothing at all", () => {
    const logger = buildLogger({ defaultLevel: "info", env: { FORKABLE_LOG: "off" } });
